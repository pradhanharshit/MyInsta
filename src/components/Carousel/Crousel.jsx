...
function Crousel() {
  return (
    <div className="flex justify-center items-center relative">
        <div className="relative h-[503px] w-[385px] bg-contain bg-no-repeat"
        style={{
            backgroundImage:"url('phone.png')"
        }}
        >
            <Carousel autoPlay={true} infiniteLoop={true} value={5000} transitionTime={1000}
            showArrows={false} showStatus={false} showIndicators={false} showThumbs={false} emulateTouch={true}
