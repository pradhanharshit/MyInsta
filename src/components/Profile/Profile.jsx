...
function Profile() {
  return (
    ...
    <img className="h-[40%] w-[100%] rounded-t-3xl" src="CoverImage.png" alt="" />
    ...
    <div className="mt-8 flex justify-around pl-8 pr-8 text-base">
        <div className="followers flex space-x-1">
            <span>0</span>
            <Link to="followers" className="font-bold text-blue-400">Followers</Link>
        </div>
        <div className="sp-ln"></div>
        <div className="following flex space-x-1">
            <span>0</span>
            <Link to="following" className="font-bold text-blue-400">Following</Link>
        </div>
    </div>
    <div className="mt-4 buttons flex justify-around">
    <div className="mt-5 mb-8 text-center text-lg font-semibold">
        <Link to="/my-profile/posts" className="px-3 py-2 rounded-3xl bg-blue-400 text-white">Posts</Link>
    </div>
    <div className="mt-5 mb-8 text-center text-lg font-semibold">
        <Link to="my-profile/Media" className="px-3 py-2 rounded-3xl bg-blue-400 text-white">Media</Link>
    </div>
    <div className="mt-5 mb-8 text-center text-lg font-semibold">
        <Link to="my-profile/Liked" className="px-3 py-2 rounded-3xl bg-blue-400 text-white">Liked</Link>
    </div>
    </div>
